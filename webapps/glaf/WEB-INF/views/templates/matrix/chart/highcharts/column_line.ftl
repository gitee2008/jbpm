...
$(document).ready(function(){
	$("button.btn").click(function(){
		...
		if(theme != null) {
		    window.location.href="${request.contextPath}/matrix/chart/highcharts/showChart?chartId=${chart.id}&charts_theme="+theme+"&chooseThemes=${chooseThemes}";
		}
    });
});
</#if>
